...
<body>
    ...
    <?php }else{ ?>
        ...
        <div class="VacanciesList__container VacanciesList__container--little" style="row-gap: 1em; margin-top:3em;grid-template-columns: 1fr">
            ...
            <div style="width: 100%; display:flex; justify-content:center">
                <a href="/novedades" style="padding:3px 6px; background-color:#3f72af; color:#fff">Reiniciar pagina</a> 
            </div>
        </div>
